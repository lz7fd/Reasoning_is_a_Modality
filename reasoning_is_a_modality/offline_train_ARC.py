...
def evaluate(
    ...
    *,
    ...
    for batch in loader:
        ...
        logits = model(inputs, contexts, task_ids, attention_mask=attention_mask)
        ...
        for epoch in range(start_epoch, args.epochs + 1):
            ...
            for step, batch in enumerate(train_loader, 1):
                ...
                with autocast(device_type=autocast_device_type, enabled=scaler.is_enabled()):
                    # feed ctx and require middle_loss for half deep supervision
                    logits, logits_middle = model(inputs, contexts, task_ids, attention_mask=attention_mask, middle_loss=True)
                    ...
                    # aux middle layer deep supervise
                    logits_middle_flat = logits_middle.permute(0, 2, 3, 1).reshape(-1, num_colors)
                    ...
                    # final loss: loss + mid_loss * weight, currently weight is 1/20 = 0.05
                    loss = loss + mid_loss * 0.05
